      ...
      <main className="pt-14">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground">
            <p>
              By accessing and using Aniflex, you accept and agree to be bound
            ...
            <p>
              The materials on Aniflex are provided on an &apos;as is&apos;
              basis. Aniflex makes no warranties, expressed or implied, and
            ...
            <p>
              Aniflex does not host any video content. All videos are hosted by
            ...
            <p>
              In no event shall Aniflex or its suppliers be liable for any
            ...
            <p>
              Aniflex may revise these terms of service at any time without
